...
<<<<<<< HEAD
 * Generated at: 2023-02-03 13:47:03 UTC
=======
<<<<<<< HEAD
 * Generated at: 2023-02-14 18:48:15 UTC
...
=======
 * Generated at: 2023-01-31 19:43:16 UTC
>>>>>>> review-5
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
...
public final class bookList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<div align=\"center\" class=\"belch\">\r\n");
      out.write("\t\r\n");
      out.write("\t<h2 class=\"bookListTitle\">List of Favorite Books</h2><BR>\r\n");
      out.write("    <form align=\"center\" name=\"bookForm\" ng-model=\"bookForm\">\r\n");
      out.write("    <br><br><label name=\"titleLabel\">Title:  <input ng-model=\"title\" type=\"text\" name=\"titleInput\" required=\"required\"/></label><br>\r\n");
      out.write("    \t<label name=\"seriesLabel\">Series:  <input ng-model=\"series\" type=\"text\" name=\"seriesInput\"/></label><br>\r\n");
      out.write("        <label name=\"authorLabel\">Author:  <input ng-model=\"author\" type=\"text\" name=\"authorInput\" required=\"required\"/></label><br>\r\n");
      out.write("        <label name=\"illustratorLabel\">Illustrator:  <input ng-model=\"illustrator\" type=\"text\" name=\"illustratorInput\" /></label><br>\r\n");
      out.write("        <label name=\"genreLabel\">Genre:  <input ng-model=\"genre\" type=\"text\" name=\"genreInput\" /></label><br>\r\n");
      out.write("        \r\n");
      out.write("        <br><br><input ng-if=\"!ctrl.book.id\" name=\"submitBookBtn\" type=\"submit\" ng-click=\"submit()\" value=\"Submit new book\" />\r\n");
      out.write("\t\t<input ng-if=\"ctrl.book.id\" name=\"updateBookBtn\" type=\"submit\" ng-click=\"ctrl.update(book)\" value=\"Update book\" />\r\n");
      out.write("\r\n");
      out.write("        \r\n");
      out.write("        <p style=\"color: red\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${error}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      ...
      out.write("\t<thead>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th name=\"columnId\">Book Id</th>\r\n");
      out.write("\t\t\t<th name=\"columnTitle\">Title</th>\r\n");
      out.write("\t\t\t<th name=\"columnSeries\">Series</th>\r\n");
      out.write("\t\t\t<th name=\"columnAuthor\">Author</th>\r\n");
      out.write("\t\t\t<th name=\"columnIllustrator\">Illustrator</th>\r\n");
      out.write("\t\t\t<th name=\"columnGenre\">Genre</th>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t</thead>\r\n");
      out.write("\t\t<tbody>\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t\t<tr id=\"bookList\" name=\"bookList\" ng-repeat=\"book in books\">\r\n");
      out.write("\t\t\t\t<td id=\"bookId-{{$index}}\" name=\"bookId\">{{book.id}}</td>\r\n");
      out.write("\t\t\t\t<td id=\"bookTitle-{{$index}}\" name=\"bookTitle\">{{book.title}}</td>\r\n");
      out.write("\t\t\t\t<td id=\"bookSeries-{{$index}}\" name=\"bookSeries\">{{book.series}}</td>\r\n");
      out.write("\t\t\t\t<td id=\"bookAuthor-{{$index}}\" name=\"bookAuthor\">{{book.author}}</td>\r\n");
      out.write("\t\t\t\t<td id=\"bookIllustrator-{{$index}}\" name=\"bookIllustrator\">{{book.illustrator}}</td>\r\n");
      out.write("\t\t\t\t<td id=\"bookGenre-{{$index}}\" name=\"bookGenre\">{{book.genre}}</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" ng-click=\"ctrl.edit(book)\" id=\"editBtn-{{$index}}\" name=\"editBtn\" class=\"btn btn-success custom-width\">Edit</button>\r\n");
      out.write("                    <button type=\"button\" ng-click=\"ctrl.remove(book)\" id=\"deleteBtn-{{$index}}\" name=\"deleteBtn\" class=\"btn btn-danger custom-width\">Remove</button>\r\n");
<<<<<<< HEAD
=======
...
>>>>>>> review-5
      ...
      out.write("\t</table>\r\n");
      out.write("</div>\r\n");
      out.write("\t  <script type=\"text/javascript\" src=\"https://ajax.googleapis.com/ajax/libs/angularjs/1.6.9/angular.js\"></script>\r\n");
